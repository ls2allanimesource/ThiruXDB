        ...
        <>
          ...
          <div className="grid gap-4">
            {endpoints.map((endpoint) => (
              <div
                key={endpoint.id}
                className={`bg-white dark:bg-gray-800/50 border rounded-lg p-4 transition flex items-start gap-3 sm:gap-4 min-w-0 ${endpoint.is_active
                ...
                <div className="flex-1 min-w-0 flex flex-col sm:flex-row gap-4 sm:items-start">
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full ${endpoint.is_active
                  ...
                  {!isViewer && (
                    <div className="flex items-center justify-end gap-2 shrink-0 border-t border-gray-100 dark:border-gray-700/50 sm:border-0 pt-3 sm:pt-0">
                      <button
                        ...
                        className={`p-2 rounded-lg transition ${endpoint.is_active
